    ...
    if (answers.opcionesPrincipales === 'Crear Cuenta') {
        inquirer
            ...
            nuevaPromesaLectura
                ...
                .then(function (contenidoCompleto) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.log('USUARIO REGISTRADO', contenidoCompleto);
                            return [4 /*yield*/, nuevaPromesaEscritura(JSON.stringify(arregloDeJson, null, ''))];
...
var nuevaPromesaEscritura = function (datos) {
    return new Promise(function (resolve, reject) {
        //const contenido = contenidoLeido ? contenidoLeido + datos : datos;
        fs.writeFile('jsonUsuarios.json', datos, function (err) {
            if (err) {
                reject(err);
            }
            else {
...
var nuevaPromesaEscrituraTXT = function (contenidoLeido, datos) {
    return new Promise(function (resolve, reject) {
